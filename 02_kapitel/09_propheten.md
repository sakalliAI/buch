...
Weil dieser Fall der einzige in diesem Kapitel ist, der ohne Konjunktiv auskommt, nehme ich ihn ausführlich auseinander. Wer verstehen will, wie ein echter Durchbruch aussieht, muss einmal einen von innen gesehen haben — sonst hält er jede Pressemitteilung für einen.
...
Warum, das hat Cyrus Levinthal 1969 in ein Gedankenexperiment gepackt, das seither seinen Namen trägt. Nimm eine mittelgroße Kette und zähle durch, wie viele räumliche Anordnungen sie theoretisch einnehmen kann. Du landest bei einer Zahl mit einer absurden Menge Nullen. Würde ein Protein diese Möglichkeiten der Reihe nach durchprobieren, bräuchte es dafür länger als das Universum alt ist. Es faltet sich aber in Millisekunden. Die Natur probiert also nicht durch, sondern nimmt eine Abkürzung — und die zu berechnen, war fünfzig Jahre lang das eigentliche Problem.[23]

Was blieb, war der harte Weg: messen statt rechnen. Röntgenkristallographie, Kernspinresonanz, später Kryo-Elektronenmikroskopie. Für die Kristallographie musst du dein Protein erst dazu bringen, einen Kristall zu bilden, und viele Proteine denken gar nicht daran. Eine einzige Struktur aufzuklären, konnte Jahre kosten und war in manchen Laboren die gesamte Doktorarbeit eines Menschen. Gesammelt wurde das Ergebnis in der Protein Data Bank, seit 1971. Als AlphaFold2 antrat, standen dort experimentell bestimmte Strukturen in der Größenordnung von hundertsiebzigtausend.[25]
...
DeepMind hätte das Verfahren einbehalten können. Stattdessen erschien 2021 die Methode samt Code, und dazu eine Datenbank: erst die Strukturen des menschlichen Proteoms und einiger Modellorganismen, ein Jahr später der Ausbau auf rund zweihundert Millionen Vorhersagen — praktisch alles, was in den Datenbanken bekannter Sequenzen stand.[25] Die AlphaFold-Datenbank wird nach Angaben von DeepMind von über zwei Millionen Forschenden in einhundertneunzig Ländern genutzt.[1]
...
Genau die haben wir in Kapitel 7 geprüft. In Edo State in Nigeria arbeiteten rund achthundert Schülerinnen und Schüler sechs Wochen lang mit GPT-4 als Tutor, begleitet von einer Lehrkraft; die Weltbank wertete den Versuch randomisiert aus und verglich den Zuwachs mit etwa zwei Jahren regulärer Schulbildung, bei rund achtundvierzig Dollar pro Kind.[30] Andreessens Satz ist also nicht aus der Luft gegriffen. Er trifft nur mit einer Bedingung zu, die im Essay nicht steht: mit Lehrkraft, als Übung, nicht als Abkürzung. Der Unterschied zwischen „möglich" und „möglich unter diesen Bedingungen" ist der Unterschied zwischen Bildungspolitik und Prospekt.
...
Russells Diagnose ist mir aus einem Grund näher als alle Prozentzahlen: Ich erlebe sie im Kleinen ständig. Wer ein System auf eine Kennzahl optimiert, bekommt genau diese Kennzahl, samt allem, was sie nicht misst. Eine Automatisierung, die auf Durchlaufzeit getrimmt ist, erledigt die einfachen Fälle blitzschnell und schiebt die schweren in ein Postfach, das niemand leert. Das ist kein Superintelligenz-Szenario. Das ist Dienstag.
...
Niemand weiß es. Und das ist keine Bequemlichkeit, sondern eine Aussage über die Beschaffenheit der Frage. Empirisch prüfbar sind die Fähigkeiten heutiger Systeme und ihre Grenzen; dafür gibt es Tests, und die kann man gewinnen oder verlieren. Der Zeitpunkt, zu dem eine allgemeine, menschenähnliche Intelligenz existiert, ist dagegen aus drei Gründen nicht messbar. Erstens ist nicht einmal definiert, woran man sie erkennen würde — jede Definition, die jemand vorlegt, wird von der Gegenseite entweder als zu schwach oder als zu streng abgelehnt, und wenn ein Kriterium erreicht ist, wandert es weiter. Zweitens gibt es keine Vorgeschichte: Wir haben genau null vorherige Fälle, aus denen sich eine Häufigkeit schätzen ließe. Drittens hängt das Ergebnis an Entscheidungen, die noch niemand getroffen hat — wie viel Kapital in welche Ansätze fließt, was reguliert wird, was an technischer Hürde noch auftaucht.

Deshalb gilt bei dieser Frage für alle Seiten dasselbe. Ob 2027, 2040 oder nie, ist bei den Enthusiasten genauso Spekulation wie bei den Skeptikern. Niemand hat Daten. Alle haben Intuitionen, unterschiedlich gut informiert. Wer dir hier Sicherheit anbietet, in welche Richtung auch immer, hat entweder nicht nachgedacht oder etwas zu verkaufen.
...
Wo genau der Unterschied entsteht, kannst du an den Zahlen oben ablesen, und das ist lehrreicher als jedes Urteil darüber, wer recht hat. Beide Seiten schätzen, welcher Anteil der Arbeit betroffen ist. Beide schätzen, welcher Anteil davon sich lohnt. Beide schätzen, wie schnell Einsparung in gemessene Produktivität übergeht. Drei Schätzungen, multipliziert. Wenn du jede einzelne um den Faktor zwei anders ansetzt — und das kann man mit guten Gründen —, steht am Ende das Achtfache.
...
Die vier Fragen ergeben zusammen keine Wahrheit. Sie ergeben eine Gewichtung. Am Ende steht bei mir meistens nicht „stimmt" oder „stimmt nicht", sondern ein Satz wie: gut begründete Meinung mit erkennbarem Eigeninteresse und ohne prüfbares Datum. Das ist wenig. Es ist aber sehr viel mehr als das, womit die meisten Diskussionen an dieser Stelle arbeiten.

## Das Werkzeug an drei alten Fällen

Damit du siehst, dass die vier Fragen nicht nur auf dem Papier funktionieren, führe ich sie an drei Fällen vor, deren Ausgang wir kennen. Historische Prognosen haben den unschätzbaren Vorteil, dass man nachsehen kann, wer recht hatte.
...
Jetzt die vier Fragen. Interesse: praktisch keins — Stoll verkaufte kein Konkurrenzprodukt, er hatte nichts davon, dass das Netz scheitert. Datum: vorhanden und klar, deshalb ließ sich der Text überhaupt widerlegen. Mechanismus: ja, und ein plausibler dazu — er beschrieb, was das Netz 1995 tatsächlich nicht konnte. Bilanz: unbekannt, es war seine erste große Vorhersage dieser Art.

Nach diesen vier Fragen hätte Stoll 1995 gut abgeschnitten. Er lag trotzdem daneben, und zwar aus einem Grund, den die vier Fragen nicht abdecken: Er hatte den Zustand der Gegenwart korrekt beschrieben und ihn stillschweigend fortgeschrieben. Der Fehler saß nicht im Argument, sondern in der Zeitachse. Ihm zugute zu halten ist, dass er es später offen einräumte, mit trockenem Spott über sich selbst.[20] Fachkenntnis schützt nicht vor Fehlprognosen. Sie sorgt nur dafür, dass man die falsche Vorhersage souveräner formuliert.

**Zweiter Fall: die Mikroelektronik-Debatte, 1980.** In der Bundesrepublik lief unter dem Stichwort „Mikroelektronik — die dritte industrielle Revolution" eine ernsthafte Auseinandersetzung über technologisch verursachte Massenarbeitslosigkeit; das war keine Stammtischsorge, sondern eine Debatte in seriösen Publikationen, mit Gutachten und Anhörungen.[28]

Vier Fragen. Interesse: gemischt und ehrlich verteilt — Gewerkschaften hatten eines, Arbeitgeberverbände auch, Wissenschaftler eher wenig. Datum: meist keins, und das ist der Schwachpunkt; „in den kommenden Jahrzehnten" ist nicht widerlegbar. Mechanismus: einer der besten, die je vorgetragen wurden — Rationalisierung ersetzt Arbeitskraft, das ist keine verlängerte Kurve, sondern eine Wirkkette. Bilanz: keine.

Und trotzdem trat die befürchtete Massenarbeitslosigkeit in dieser Form nicht ein. Für Deutschland zeigt die Forschung, dass Regionen mit hoher Automatisierungsexposition keine überdurchschnittlichen Jobverluste erlitten und Produktivitätszuwächse eher mit regionalem Beschäftigungswachstum einhergingen.[29] Der Mechanismus war richtig beschrieben und trotzdem unvollständig: Er erfasste die verschwindenden Tätigkeiten und nicht die entstehenden. Daraus lernst du etwas Unbequemes über die dritte Frage. Ein genannter Mechanismus ist besser als eine verlängerte Kurve, aber er ist keine Garantie. Er ist ein Ausschnitt, und wer den Ausschnitt wählt, wählt das Ergebnis mit.
...
Interessanterweise besteht dieser Satz die eigenen vier Fragen nicht besonders gut. Ein Datum steht nicht darin. Ein Mechanismus auch nicht — er beschreibt ein Muster, nicht dessen Ursache. Streng genommen ist Amaras Gesetz genau die Sorte unwiderlegbarer Aussage, vor der ich dich gerade gewarnt habe: Egal was passiert, sie lässt sich hinterher passend machen.

Ich halte sie trotzdem für nützlich, und ich sage dir warum. Sie taugt nicht als Prognose, aber sehr gut als Korrektur der eigenen Erwartung. Angewandt auf unsere drei Lager heißt sie: Die Optimisten haben für das nächste Jahr wahrscheinlich unrecht und für das nächste Jahrzehnt möglicherweise recht. Die Skeptiker haben für das nächste Jahr wahrscheinlich recht und laufen Gefahr, das Jahrzehnt zu verpassen. Beide sagen die Wahrheit über verschiedene Zeitfenster und streiten dann darüber, wer lügt. Nimm den Satz also als Werkzeug für dich selbst, nicht als Argument gegen andere.
...
Damit das nicht in der Behauptung stehen bleibt, drei Stellen, an denen Ankündigung und Wirklichkeit in meinem Berufsalltag auseinanderfielen. Ich nenne keine Hersteller, weil das Muster wichtiger ist als der Name, und weil ich es bei allen gesehen habe.

Die erste: die Demo mit fünf Dokumenten. Ein System liest Rechnungen aus, erkennt Positionen, ordnet Kostenstellen zu, alles auf der Bühne in achtzig Sekunden. Im Pilotbetrieb kommen dann viertausend Dokumente aus elf Jahren, davon ein Teil als schief eingescanntes Fax, ein Teil mit einem Lieferantennamen, der 2017 geändert wurde, und ein Teil mit handschriftlichen Vermerken am Rand, die im Zweifel wichtiger sind als der gedruckte Text. Die Trefferquote fällt nicht dramatisch. Sie fällt genau so weit, dass jemand jeden Vorgang nachsehen muss — und damit ist der Nutzen weg, denn Prüfen kostet fast so viel wie Machen. Der Unterschied zwischen fünf und viertausend ist kein quantitativer. Er ist der ganze Unterschied.

Die zweite: der Zeitgewinn, der woanders wieder verschwindet. Wir haben Aufgaben, bei denen ein Modell heute in einer Stunde erledigt, wofür früher zwei Tage angesetzt waren. Das ist real, ich habe es mehrfach gemessen. Nur ist die Erstellung selten der Engpass gewesen. Der Engpass war die Abstimmung — wer schaut drüber, wer gibt frei, wessen Fachbereich muss zustimmen. Diese Woche Wartezeit hat kein Modell verkürzt. Wenn du Automatisierung an der falschen Stelle einbaust, bekommst du ein sehr schnelles Teilstück in einem gleich langsamen Prozess. Das ist der häufigste Grund, warum Produktivitätsversprechen sich nicht in Zahlen niederschlagen, und er ist so unglamourös, dass ihn kein Vortrag erwähnt.

Die dritte, und sie geht gegen meine eigene Skepsis. Ich habe abends Werkzeuge gebaut, für die ich vor fünf Jahren einen Entwickler und ein Budget gebraucht hätte, und zwar in einer Sitzung. Nicht als Prototyp, sondern als Ding, das seither läuft. Wer diese Erfahrung nicht gemacht hat und über KI redet, redet über Berichte. Der Haken: Das Ding läuft für einen Nutzer, mit einem Eingabeformat, ohne Rechteverwaltung, ohne Protokollierung, ohne Vertretungsregelung. Dasselbe für zweihundert Kollegen belastbar zu machen, ist weiterhin Monatsarbeit. Der Sprung liegt am Anfang und nicht am Ende, und beide Lager reden, als läge er in der Mitte.
...
Damit kommen wir an die Grenze dessen, was dieses Kapitel leisten kann. Du kannst jetzt eine Zukunftsaussage auseinandernehmen. Du weißt, dass der stärkste Beleg der Optimisten echt ist und trotzdem nichts über die nächsten zwanzig Jahre beweist. Du weißt, dass die ernsthaftesten Warner aus dem Maschinenraum kommen und ihre Zahlen dennoch Schätzungen bleiben. Du weißt, dass die Skeptiker gute Gründe haben und dass zwei seriöse Ökonomen bei derselben Technik um den Faktor zehn auseinanderliegen können.

Was du nicht bekommen hast, ist die Antwort auf die Frage, was kommt. Die hat niemand, und wer sie anbietet, hat dieses Kapitel nicht nötig gehabt.
...
[23] ▲ Christian B. Anfinsen: Nobelpreis für Chemie 1972 (u. a. für die Arbeiten zur Ribonuklease); „Anfinsen-Dogma": Die Information für die native Faltung ist in der Aminosäuresequenz enthalten. Cyrus Levinthal: *How to Fold Graciously* (1969) — Levinthal-Paradox: astronomische Zahl möglicher Konformationen gegenüber Faltungszeiten im Millisekundenbereich. NobelPrize.org; Standardliteratur der Strukturbiologie. → QUELLEN.md Nr. 119. **[belegt]** — *Jahreszahlen, Preisbegründung und die Formulierung des Levinthal-Arguments vor Drucklegung an Primär- bzw. Standardliteratur prüfen; im Text sind keine Wortzitate gesetzt.*

[24] ▲ CASP — *Critical Assessment of Structure Prediction*, initiiert 1994 von John Moult u. a., zweijährliche Blindprüfung; CASP13 (2018) erster AlphaFold-Sieg; CASP14 (2020) AlphaFold2 mit einem Median-GDT-Wert um 92 über die Zielproteine, Schwellenbereich um 90 als experimentnahe Genauigkeit; Einordnung der Organisatoren, das Problem sei in wesentlichem Sinn gelöst. predictioncenter.org; Berichterstattung Nature 2020. → QUELLEN.md Nr. 120. **[belegt]** — *Exakter Medianwert, Bewertungsmetrik und die Formulierung der Organisatoren vor Drucklegung am CASP14-Bericht verifizieren; die Aussage der Organisatoren ist im Text sinngemäß und ohne Wortzitat wiedergegeben.*

[25] ▲ Protein Data Bank (seit 1971) als Archiv experimentell bestimmter Strukturen, Bestand zum Zeitpunkt von AlphaFold2 in der Größenordnung von 170.000 Einträgen; AlphaFold2-Veröffentlichung (Nature, Juli 2021) samt Code; AlphaFold Protein Structure Database (DeepMind/EMBL-EBI), Start Juli 2021 mit Humanproteom und Modellorganismen, Ausbau Juli 2022 auf über 200 Mio. Vorhersagen. rcsb.org; alphafold.ebi.ac.uk. → QUELLEN.md Nr. 121. **[belegt]** — *Bestandszahl der PDB und die Ausbaudaten der AlphaFold-Datenbank vor Drucklegung an den Betreiberangaben prüfen.*

[26] ▲ Grenzen der Strukturvorhersage: Konfidenzmaß pLDDT je Rest; niedrige Konfidenz bei intrinsisch ungeordneten Bereichen; keine Aussage über Faltungsweg und Dynamik; unzuverlässige Erfassung der Effekte einzelner Mutationen; Molekülkomplexe erst mit Nachfolgemodellen (AlphaFold-Multimer; AlphaFold3, Nature, Mai 2024). → QUELLEN.md Nr. 122. **[belegt]** — *Die Einzelpunkte vor Drucklegung an der AlphaFold2/3-Primärliteratur und an methodenkritischen Übersichtsarbeiten belegen. Die Bemerkung, das Modell stehe auf den Daten der experimentellen Strukturbiologie, ist im Text als Überlegung des Autors formuliert.*

[27] ▲ Andrew Ng: Mitgründer von Coursera und Gründer von DeepLearning.AI; Tätigkeit in Lehre und Anwendung von KI. → QUELLEN.md Nr. 123. **[belegt]** — *Im Text ausschließlich als Interessenlage angeführt, ausdrücklich ohne Behauptung, dies entwerte seine Argumente.*

[28] ▲ Bundeszentrale für politische Bildung, *Aus Politik und Zeitgeschichte* 7/1980: *Mikroelektronik — die dritte industrielle Revolution*. — Zeitgenössische Debatte über technologisch verursachte Massenarbeitslosigkeit. Call-back auf Kapitel 5 und 6. → QUELLEN.md Nr. 30. **[belegt als zeitgenössische Debatte]** — *Belegstelle vor Drucklegung prüfen; die Bewertung des Ausgangs ist im Text als Einordnung des Autors markiert.*
